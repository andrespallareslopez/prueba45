...
"use strict";
   ...
   ns.table.prototype.extend=(function(){
   ...
   ns.table.prototype.config={};
   ns.table.prototype.options={};
   ns.table.prototype.metadata={};
   ns.table.prototype.init=function(options){
         //this.config={};
         (function(config){
   ...
   ns.table.prototype.render=function(){
      renderTable.apply(this,[]);   
   };
   ns.table.prototype.initEvent=function(){
       var self=this;
...
var inputdecimalstring=function(that,idInput){
    ...
    var objeto=$("<input  />",
     {"id":idInput,
      ...
      "type":this.inputType,
      "onkeypress":"return components.isNumberKey(event)",
      //"width":($(that).width())+"px",
      "width":"calc(100% - 16px)",
     ...
     //
      var objeto=$("<input  />",
       {"id":idInput,
        "value":valor,
        "type":this.inputType,
        "onkeypress":"return components.isIntegerKey(event)",
        //"width":($(that).width())+"px",
        "width":"calc(100% - 16px)",
        "class":"input-ctrl mousetrap",
